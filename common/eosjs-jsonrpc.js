var eosjs_jsonrpc = function(t) {
    ...
    11: function(t, e, r) {
        ...
        function p(t, e) {
            ...
            try {
                for (var l = i(t), h = l.next(); !h.done; h = l.next()) {
                    for (var d = h.value, v = 0; v < f.length; ++v) {
                        var y = (s[f[v]] << 8) + d;
                        f[v] = c.charCodeAt(y % 58), d = y / 58 | 0
                    }
                    for (; d;) f.push(c.charCodeAt(d % 58)), d = d / 58 | 0
                }
            } catch (t) {
                r = {
                    error: t
            ...
            return f.reverse(), String.fromCharCode.apply(String, o(f))
        }
        ...
        function g(t, e, r) {
            for (var n = new Uint8Array(_(t.data, e)), o = new Uint8Array(t.data.length + 4), i = 0; i < t.data.length; ++i) o[i] = t.data[i];
        ...
        function m(t) {
            if (0 === t.type && t.data.length === e.publicKeyDataSize) return g(t, "K1", "PUB_K1_");
            if (1 === t.type && t.data.length === e.publicKeyDataSize) return g(t, "R1", "PUB_R1_");
            throw new Error("unrecognized public key format")
        }
        ...
        e.isNegative = l, e.negate = h, e.decimalToBinary = d, e.signedDecimalToBinary = function(t, e) {
            var r = "-" === e[0];
            r && (e = e.substr(1));
            var n = d(t, e);
            if (r) {
                if (h(n), !l(n)) throw new Error("number is out of range")
            } else if (l(n)) throw new Error("number is out of range");
            return n
        }, e.binaryToDecimal = v, e.signedBinaryToDecimal = function(t, e) {
            if (void 0 === e && (e = 1), l(t)) {
                var r = t.slice();
                return h(r), "-" + v(r, e)
            }
            return v(t, e)
        }, e.base58ToBinary = y, e.binaryToBase58 = p, e.base64ToBinary = function(t) {
            var e = t.length;
            ...
            return o
        }, e.publicKeyDataSize = 33, e.privateKeyDataSize = 32, e.signatureDataSize = 65, e.stringToPublicKey = w, e.publicKeyToString = m, e.convertLegacyPublicKey = S, e.convertLegacyPublicKeys = function(t) {
            return t.map(S)
            ...
            if (1 === t.type) return g(t, "R1", "PVT_R1_");
            throw new Error("unrecognized private key format")
            ...
            if (0 === t.type) return g(t, "K1", "SIG_K1_");
            if (1 === t.type) return g(t, "R1", "SIG_R1_");
            throw new Error("unrecognized signature format")
        }
    },
    12: function(t, e, r) {
            ...
            static hash(t) {
                ...
                for (let t = 0; t < c; ++t) {
                    ...
                    for (let s = 0; s < 80; ++s) {
                        ...
                        e = h, h = l, l = n.rol32(f, 10), f = c, c = b, b = n.add_modulo32(n.rol32(n.add_modulo32(d, n.f(79 - s, v, y, p), u[t](o[s]), n.KP(s)), a[s]), _), d = _, _ = p, p = n.rol32(y, 10), y = v, v = b
                    }
                    let b = n.add_modulo32(s[1], f, p);
                    s[1] = n.add_modulo32(s[2], l, _), s[2] = n.add_modulo32(s[3], h, d), s[3] = n.add_modulo32(s[4], e, v), s[4] = n.add_modulo32(s[0], c, y), s[0] = b
                }
                const f = new ArrayBuffer(20),
                    l = new DataView(f);
                return s.forEach((t, e) => l.setUint32(4 * e, t, !0)), f
            }
        }
        t.exports = {
            RIPEMD160: n
                    ...
                    return n(this, void 0, void 0, function() {
                        ...
                        return o(this, function(o) {
                            switch (o.label) {
                                ...
                                case 2:
                                    if ((n = o.sent()).processed && n.processed.except) throw new c.default(n);
                                    return [3, 4];
                                case 3:
                                    throw (i = o.sent()).isFetchError = !0, i;
                                case 4:
                                    if (!r.ok) throw new c.default(n);
                                    return [2, n]
                            }
                        })
                    })
