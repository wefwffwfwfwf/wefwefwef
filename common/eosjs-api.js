var eosjs_api = function(e) {
    ...
    11: function(e, t, r) {
        ...
        function y(e, t) {
            ...
            for (var r = Array(t).fill("0".charCodeAt(0)), n = e.length - 1; n >= 0; --n) {
                for (var a = e[n], o = 0; o < r.length; ++o) {
                    ...
                    r[o] = "0".charCodeAt(0) + s % 10, a = s / 10 | 0
                }
            ...
            try {
                for (var f = a(e), h = f.next(); !h.done; h = f.next()) {
                    for (var p = h.value, y = 0; y < l.length; ++y) {
                        var d = (c[l[y]] << 8) + p;
                        l[y] = s.charCodeAt(d % 58), p = d / 58 | 0
                    }
        ...
        function w(e) {
            ...
            if ("PUB_K1_" === e.substr(0, 7)) return v(e.substr(7), 0, t.publicKeyDataSize, "K1");
            if ("PUB_R1_" === e.substr(0, 7)) return v(e.substr(7), 1, t.publicKeyDataSize, "R1");
            throw new Error("unrecognized public key format")
        }

        function _(e) {
            if (0 === e.type && e.data.length === t.publicKeyDataSize) return b(e, "K1", "PUB_K1_");
        ...
        t.isNegative = f, t.negate = h, t.decimalToBinary = p, t.signedDecimalToBinary = function(e, t) {
            var r = "-" === t[0];
            r && (t = t.substr(1));
            var n = p(e, t);
            if (r) {
                if (h(n), !f(n)) throw new Error("number is out of range")
            } else if (f(n)) throw new Error("number is out of range");
            return n
            ...
            return y(e, t)
        }, t.base58ToBinary = d, t.binaryToBase58 = g, t.base64ToBinary = function(e) {
            var t = e.length;
            ...
            return i
        }, t.publicKeyDataSize = 33, t.privateKeyDataSize = 32, t.signatureDataSize = 65, t.stringToPublicKey = w, t.publicKeyToString = _, t.convertLegacyPublicKey = A, t.convertLegacyPublicKeys = function(e) {
            return e.map(A)
        }, t.stringToPrivateKey = function(e) {
            if ("string" != typeof e) throw new Error("expected string containing private key");
            if ("PVT_R1_" === e.substr(0, 7)) return v(e.substr(7), 1, t.privateKeyDataSize, "R1");
            throw new Error("unrecognized private key format")
        }, t.privateKeyToString = function(e) {
            if (1 === e.type) return b(e, "R1", "PVT_R1_");
            throw new Error("unrecognized private key format")
        }, t.stringToSignature = function(e) {
            if ("string" != typeof e) throw new Error("expected string containing signature");
            if ("SIG_K1_" === e.substr(0, 7)) return v(e.substr(7), 0, t.signatureDataSize, "K1");
            if ("SIG_R1_" === e.substr(0, 7)) return v(e.substr(7), 1, t.signatureDataSize, "R1");
            throw new Error("unrecognized signature format")
        }, t.signatureToString = function(e) {
            if (0 === e.type) return b(e, "K1", "SIG_K1_");
    ...
    12: function(e, t, r) {
        ...
        class n {
            ...
            static pad(e) {
                ...
                return s.setUint8(t, 128), s.setUint32(t + r, a, !0), s.setUint32(t + r + 4, i, !0), o.buffer
            }
            static f(e, t, r, n) {
            ...
            static hash(e) {
                ...
                for (let e = 0; e < s; ++e) {
                    ...
                    for (let c = 0; c < 80; ++c) {
                        ...
                        t = h, h = f, f = n.rol32(l, 10), l = s, s = v, v = n.add_modulo32(n.rol32(n.add_modulo32(p, n.f(79 - c, y, d, g), u[e](i[c]), n.KP(c)), o[c]), m), p = m, m = g, g = n.rol32(d, 10), d = y, y = v
                    }
                    let v = n.add_modulo32(c[1], l, g);
                    c[1] = n.add_modulo32(c[2], f, m), c[2] = n.add_modulo32(c[3], h, p), c[3] = n.add_modulo32(c[4], t, y), c[4] = n.add_modulo32(c[0], s, d), c[0] = v
                }
                const l = new ArrayBuffer(20),
                    f = new DataView(l);
                return c.forEach((e, t) => f.setUint32(4 * t, e, !0)), l
            }
        }
        e.exports = {
            RIPEMD160: n
                ...
                return e.prototype.rawAbiToJson = function(e) {
                    ...
                    return void 0 === t && (t = !1), i(this, void 0, void 0, function() {
                        ...
                        return a(this, function(c) {
                            return r = e.actions.map(function(e) {
                                return e.account
                            }), n = new Set(r), o = u(n).map(function(e) {
                    ...
                    return void 0 === t && (t = !1), i(this, void 0, void 0, function() {
                        ...
                        return a(this, function(a) {
                            switch (a.label) {
                                ...
                                case 1:
                                    i = a.sent(), o = l.getTypesFromAbi(l.createInitialTypes(), i), s = new Map;
                                    try {
                                        for (u = c(i.actions), f = u.next(); !f.done; f = u.next()) h = f.value, p = h.name, y = h.type, s.set(p, l.getType(o, y))
                                    } catch (e) {
                                        r = {
                                            error: e
                                        }
                                        ...
                                        return i(t, void 0, void 0, function() {
                                            ...
                                            return a(this, function(t) {
                                                switch (t.label) {
                                                    ...
                                                    case 1:
                                                        return e = t.sent(), [2, l.serializeAction(e, r, n, o, s, this.textEncoder, this.textDecoder)]
                                                }
                                            })
                                        })
                                    }))];
                                            ...
                                            return a(this, function(t) {
                                                switch (t.label) {
                                                    case 0:
                                                        return [4, this.getContract(r)];
                                                    case 1:
                                                        return e = t.sent(), [2, l.deserializeAction(e, r, n, o, s, this.textEncoder, this.textDecoder)]
                                                }
                                            })
                                        })
                                    }))];
                    ...
                    return i(this, void 0, void 0, function() {
                        ...
                        return a(this, function(i) {
                            switch (i.label) {
                                case 0:
                                    return "string" == typeof e && (e = l.hexToUint8Array(e)), t = this.deserializeTransaction(e), [4, this.deserializeActions(t.actions)];
                                case 1:
                    ...
                    return i(this, void 0, void 0, function() {
                        ...
                        return a(this, function(a) {
                            switch (a.label) {
                                ...
                                case 5:
                                    r = a.sent(), e = n({}, l.transactionHeader(r, h), e), a.label = 6;
                                case 6:
                                ...
                                case 7:
                                    return i = a.sent(), o = [{}, e], u = {}, [4, this.serializeActions(e.actions)];
                                case 8:
                                    return e = n.apply(void 0, o.concat([(u.actions = a.sent(), u)])), p = this.serializeTransaction(e), y = {
                                        serializedTransaction: p,
                                        signatures: []
                                    }, c ? [4, this.signatureProvider.getAvailableKeys()] : [3, 12];
                                case 9:
                                    return d = a.sent(), [4, this.authorityProvider.getRequiredKeys({
                                        transaction: e,
                                        availableKeys: d
                                    })];
                                case 10:
                                    return g = a.sent(), [4, this.signatureProvider.sign({
    ...
    53: function(e, t, r) {
        ...
        function N(e, t, r, n, i, a) {
            ...
            return o.serialize(s, n), b(s.asUint8Array())
        }
        ...
        function R(e, t, r, n, i, a) {
            ...
            return s.pushArray(n), o.deserialize(s)
        }
        t.SerialBuffer = c, t.supportedAbiVersion = function(e) {
            return e.startsWith("eosio::abi/1.")
        }, t.dateToTimePoint = f, t.timePointToDate = h, t.dateToTimePointSec = p, t.timePointSecToDate = y, t.dateToBlockTimestamp = d, t.blockTimestampToDate = g, t.stringToSymbol = m, t.symbolToString = v, t.arrayToHex = b, t.hexToUint8Array = w, t.createInitialTypes = function() {
        ...
        }, t.getType = B, t.getTypesFromAbi = function(e, t) {
            ...
            try {
                for (var R = o(y), M = R.next(); !M.done; M = R.next()) {
                    var V = i(M.value, 2);
                    V[0], (b = V[1]).baseName && (b.base = B(y, b.baseName));
                    try {
        ...
        }, t.serializeActionData = N, t.serializeAction = function(e, t, r, n, i, a, o) {
            return {
                account: t,
                name: r,
                authorization: n,
        ...
        }, t.deserializeActionData = R, t.deserializeAction = function(e, t, r, n, i, a, o) {
            return {
                account: t,
                name: r,
                authorization: n,
