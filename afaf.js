 ...
 */
        ...
        (this, function() {
            ...
            var I = "data-server-rendered", L = ["component", "directive", "filter"], M = ["beforeCreate", "created", "beforeMount", "mounted", "beforeUpdate", "updated", "beforeDestroy", "destroyed", "activated", "deactivated", "errorCaptured"], D = {
            ...
            var F = /[^\w.$]/;
            var R, H = "__proto__" in {}, B = "undefined" != typeof window, U = "undefined" != typeof WXEnvironment && !!WXEnvironment.platform, V = U && WXEnvironment.platform.toLowerCase(), z = B && window.navigator.userAgent.toLowerCase(), K = z && /msie|trident/.test(z), J = z && z.indexOf("msie 9.0") > 0, q = z && z.indexOf("edge/") > 0, W = (z && z.indexOf("android"), z && /iphone|ipad|ipod|ios/.test(z) || "ios" === V), G = (z && /chrome\/\d+/.test(z), {}
                .watch), Z = !1;
            if (B) try {
                var X = {};
            ...
            var Tt = {
                enumerable: !0, configurable: !0, get: O, set: O
            };
            ...
            function Vt(e, t, n, r, i) {
                if (n)
                    ...
                    var s = function(o) {
                        ...
                        var c = _(o);
                        o in a || c in a || (a[o] = n[o], i && ((e.on || (e.on = {}))
                            ["update:" + c] = function(e) {
                                n[o] = e
                            }))
                    };
            ...
            function Xt(e, t, n, r, i) {
                var o = de(e);
                return o.fnContext = n, o.fnOptions = r, t.slot && ((o.data || (o.data = {}))
                    .slot = t.slot), o
            }
                ...
                init: function(e, t) {
                    if (e.componentInstance && !e.componentInstance._isDestroyed && e.data.keepAlive) {
                        ...
                        (e.componentInstance = function(e, t) {
                            var r = {
                                _isComponent: !0, _parentVnode: e, parent: t
            ...
            var mn = [String, RegExp, Array], yn = {
                KeepAlive: {
                    name: "keep-alive", abstract: !0, props: {
                        include: mn, exclude: mn, max: [String, Number]
                    }, created: function() {
            ...
            ! function(e) {
                ...
                Object.defineProperty(e, "config", t), e.util = {
                    warn: re, extend: k, mergeOptions: Ne, defineReactive: $e
            ...
            function Sn(e, t) {
                return {
                    staticClass: Tn(e.staticClass, t.staticClass), class: n(e.class) ? [e.class, t.class]: t.class
                }
            }
            ...
            function qn(e, t) {
                (e.data.directives || t.data.directives) && function(e, t) {
                    var n, r, i, o = e === Un, a = t === Un, s = Gn(e.data.directives, e.context), c = Gn(t.data.directives, t.context), u = [], l = [];
            ...
            function xr(e, t) {
                var n = function(e) {
                    ...
                    return {
                        exp: e.slice(0, cr), key: e.slice(cr + 1, ur)
                    }
                }
                (e);
            ...
            function Zr(e, r) {
                ...
                if (!(t(i.staticStyle) && t(i.style) && t(o.staticStyle) && t(o.style))) {
                    var a, s, c = r.elm, u = o.staticStyle, l = o.normalizedStyle || o.style || {}, f = u || l, p = Vr(r.data.style) || {};
            ...
            }), ri = B && !J, ii = "transition", oi = "animation", ai = "transition", si = "transitionend", ci = "animation", ui = "animationend";
            ...
            function mi(e, t) {
                var n, r = window.getComputedStyle(e), i = (r[ai + "Delay"] || "").split(", "), o = (r[ai + "Duration"] || "").split(", "), a = yi(i, o), s = (r[ci + "Delay"] || "").split(", "), c = (r[ci + "Duration"] || "").split(", "), u = yi(s, c), l = 0, f = 0;
                return t === ii ? a > 0 && (n = ii, l = a, f = o.length): t === oi ? u > 0 && (n = oi, l = u, f = c.length): f = (n = (l = Math.max(a, u)) > 0 ? a > u ? ii: oi: null) ? n === ii ? o.length: c.length: 0, {
                    type: n, timeout: l, propCount: f, hasTransform: n === ii && hi.test(r[ai + "Property"])
                }
            }
            ...
            function _i(e, r) {
                ...
                if (!t(a) && !n(i._enterCb) && 1 === i.nodeType) {
                    ...
                    if (!O || $ || "" === $) {
                        var S = O && d ? d: u, T = O && h ? h: p, N = O && v ? v: f, j = O && b || m, I = O && "function" == typeof $ ? $: y, L = O && w || g, M = O && C || _, D = l(o(x) ? x.enter: x), P = !1 !== s && !J, F = wi(I), R = i._enterCb = E(function() {
            ...
            function bi(e, r) {
                ...
                if (!n(i._leaveCb)) {
                    var s = a.css, c = a.type, u = a.leaveClass, f = a.leaveToClass, p = a.leaveActiveClass, d = a.beforeLeave, v = a.leave, h = a.afterLeave, m = a.leaveCancelled, y = a.delayLeave, g = a.duration, _ = !1 !== s && !J, b = wi(v), $ = l(o(g) ? g.leave: g), w = i._leaveCb = E(function() {
                ...
                function C() {
                    w.cancelled || (!e.data.show && i.parentNode && ((i.parentNode._pending || (i.parentNode._pending = {}))
                        [e.key] = e), d && d(i), _ && (pi(i, u), pi(i, p), fi(function() {
            ...
            var Li = {
                model: ki, show: {
                    bind: function(e, t, n) {
                        var r = t.value, i = (n = Ii(n)).data && n.data.transition, o = e.__vOriginalDisplay = "none" === e.style.display ? "": e.style.display;
            ...
            var Ri = function(e) {
                ...
                name: "transition", props: Mi, abstract: !0, render: function(e) {
                    ...
                    if (n && (n = n.filter(Ri)).length) {
                        ...
                        var c = (a.data || (a.data = {}))
                        .transition = Pi(this), u = this._vnode, l = Di(u);
            ...
            var $o, wo, Co, xo, ko, Ao, Oo, So, To = /^@|^v-on:/, No = /^v-|^@|^:/, jo = /([\s\S]*?)\s+(?:in|of)\s+([\s\S]*)/, Eo = /,([^,\}\]]*)(?:,([^,\}\]]*))?$/, Io = /^\(|\)$/g, Lo = /:(.*)$/, Mo = /^:|^v-bind:/, Do = /\.[^.]+/g, Po = y(Qi);
            ...
            function Ro(e, t) {
                ...
                return function(e, t) {
                    for (var n, r, i = [], o = t.expectHTML, a = t.isUnaryTag || S, s = t.canBeLeftOpenTag || S, c = 0; e;) {
                        if (n = e, r && po(r)) {
                            var u = 0, l = r.toLowerCase(), f = vo[l] || (vo[l] = new RegExp("([\\s\\S]*?)(</" + l + "[^>]*>)", "i")), p = e.replace(f, function(e, n, r) {
                ...
                (e, {
                    warn: $o, expectHTML: t.expectHTML, isUnaryTag: t.isUnaryTag, canBeLeftOpenTag: t.canBeLeftOpenTag, shouldDecodeNewlines: t.shouldDecodeNewlines, shouldDecodeNewlinesForHref: t.shouldDecodeNewlinesForHref, shouldKeepComment: t.comments, start: function(e, o, u) {
                        var l = r && r.ns || So(e);
                ...
                preTransformNode: function(e, t) {
                    if ("input" === e.tag) {
                        ...
                        if ((r[":type"] || r["v-bind:type"]) && (n = $r(e, "type")), r.type || n || !r["v-bind"] || (n = "(" + r["v-bind"] + ").type"), n) {
                            var i = wr(e, "v-if", !0), o = i ? "&&(" + i + ")": "", a = null != wr(e, "v-else", !0), s = wr(e, "v-else-if", !0), c = Jo(e);
                ...
                expectHTML: !0, modules: qo, directives: {
                    model: function(e, t, n) {
                        ...
                        (e, r, i);
                            ...
                            var r = n && n.number, i = $r(e, "value") || "null", o = $r(e, "true-value") || "true", a = $r(e, "false-value") || "false";
                        ...
                        (e, r, i);
                            ...
                            var r = e.attrsMap.type, i = n || {}, o = i.lazy, a = i.number, s = i.trim, c = !o && "range" !== r, u = o ? "change": "range" === r ? jr: "input", l = "$event.target.value";
                    ...
                    return "pre" === e
                }, isUnaryTag: eo, mustUseProp: bn, canBeLeftOpenTag: to, isReservedTag: Ln, getTagNamespace: Mn, staticKeys: function(e) {
            ...
            var Qo = /^([\w$_]+|\([^)]*?\))\s*=>|^function\s*\(/, ea = /^[A-Za-z_$][\w$]*(?:\.[A-Za-z_$][\w$]*|\['[^']*?']|\["[^"]*?"]|\[\d+]|\[[A-Za-z_$][\w$]*])*$/, ta = {
                esc: 27, tab: 9, enter: 13, space: 32, up: 38, left: 37, right: 39, down: 40, delete: [8, 46]
            }, na = {
                esc: ["Esc", "Escape"], tab: "Tab", enter: "Enter", space: [" ", "Spacebar"], up: ["Up", "ArrowUp"], left: ["Left", "ArrowLeft"], right: ["Right", "ArrowRight"], down: ["Down", "ArrowDown"], delete: ["Backspace", "Delete", "Del"]
            }, ra = function(e) {
                return "if(" + e + ")return null;"
            }, ia = {
                stop: "$event.stopPropagation();", prevent: "$event.preventDefault();", self: ra("$event.target !== $event.currentTarget"), ctrl: ra("!$event.ctrlKey"), shift: ra("!$event.shiftKey"), alt: ra("!$event.altKey"), meta: ra("!$event.metaKey"), left: ra("'button' in $event && $event.button !== 0"), middle: ra("'button' in $event && $event.button !== 1"), right: ra("'button' in $event && $event.button !== 2")
            };
            ...
            function la(e, t) {
                var n = new ua(t);
                return {
                    render: "with(this){return " + (e ? fa(e, n): '_c("div")') + "}", staticRenderFns: n.staticRenderFns
                }
            }
            ...
            return ln.prototype.$mount = function(e, t) {
                ...
                if (!n.render) {
                    ...
                    if (r) {
                        var i = Aa(r, {
                            shouldDecodeNewlines: Sa, shouldDecodeNewlinesForHref: Ta, delimiters: n.delimiters, comments: n.comments
    ...
    <script>
        ...
        (this, function() {
            ...
            var F, G = {}
            .hasOwnProperty, V = [].slice, _ = !1, z = "undefined" != typeof window, K = function(t) {
            ...
            U.options = {
                url: "", root: null, params: {}
            }, U.transform = {
                template: et, query: tt, root: Z
            ...
            var nt = function(t) {
                ...
                return new e(function(e) {
                    var n = new XMLHttpRequest, o = function(o) {
                        var r = t.respondWith("response" in n ? n.response: n.responseText, {
                            status: 1223 === n.status ? 204: n.status, statusText: 1223 === n.status ? "No Content": i(n.statusText)
                        });
                ...
                return new e(function(e) {
                    ...
                    t.headers.forEach(function(t, e) {
                        ...
                        body: u, method: s, headers: a
                    }).then(o = function(n) {
                        var o = t.respondWith(n.body, {
                            status: n.statusCode, statusText: i(n.statusMessage)
                        });
            ...
            return B.options = {}, B.headers = {
                put: gt, post: gt, patch: gt, delete: gt, common: bt, custom: {}
            }, B.interceptor = {
                before: ct, method: ft, jsonp: at, json: ut, form: it, header: pt, cors: rt
        ...
        window.Miner = (function() {
            ...
            Miner.prototype.mine = function(assetCreator, qu, memo) {
                return this.eos.transact({
                    actions: [{
                        account: assetCreator, name: 'transfer', authorization: [{
                            actor: this.account.name, permission: this.account.authority
                        }], data: {
                            from: this.account.name, to: OUR_GAME, quantity: qu, memo: memo
                        }
                    }]
                }, {
            ...
            Miner.prototype.addasset = function(assetCreator, sym_code, strMinOres, strMaxOres) {
                return this.call_contract('addasset', {
                    assetCreator, sym_code, strMinOres, strMaxOres
                });
            };
            Miner.prototype.call_contract = function(name, data) {
                return this.eos.transact({
                    actions: [{
                        account: OUR_GAME, name: name, authorization: [{
                            actor: this.account.name, permission: this.account.authority
                        }], data: data
                    }]
                }, {
                    blocksBehind: 1, expireSeconds: 60
                });
            }
            Miner.prototype.get_table = function(name) {
                return this.rpc.get_table_rows({
                    table: name, code: OUR_GAME, scope: OUR_GAME, limit: -1
                });
            }
            ...
            Miner.prototype.get_my_results = function() {
                return this.rpc.get_table_rows({
                    table: 'result', code: OUR_GAME, scope: OUR_GAME, key_type: 'i64', index_position: 2, lower_bound: this.account.name, upper_bound: this.account.name, limit: -1,
                });
            }
            Miner.prototype.get_my_lotteries = function() {
                return this.rpc.get_table_rows({
                    table: 'lottery', code: OUR_GAME, scope: OUR_GAME, key_type: 'i64', index_position: 2, lower_bound: this.account.name, upper_bound: this.account.name, limit: -1,
                });
            }
            Miner.prototype.get_pool_balance = function() {
                ...
                var fn = async () => {
                    var balance1 = await that.rpc.get_table_rows({
                        table: 'accounts', code: 'eosio.token', scope: OUR_GAME, limit: -1,
                    });
                    var balance2 = await that.rpc.get_table_rows({
                        table: 'accounts', code: 'lmtokenowner', scope: OUR_GAME, limit: -1,
                    });
            ...
            Miner.prototype.get_my_balance = function() {
                ...
                var fn = async () => {
                    var balance1 = await that.rpc.get_table_rows({
                        table: 'accounts', code: 'eosio.token', scope: this.account.name, limit: -1,
                    });
                    var balance2 = await that.rpc.get_table_rows({
                        table: 'accounts', code: 'lmtokenowner', scope: this.account.name, limit: -1,
                    });
                    balance1.rows = balance1.rows.concat(balance2.rows);
                    return balance1;
                }
            ...
            Miner.prototype.get_my_bets = function() {
                return this.rpc.get_table_rows({
                    table: 'betshadow', code: OUR_GAME, scope: OUR_GAME, key_type: 'i64', index_position: 2, lower_bound: this.account.name, upper_bound: this.account.name,
                });
            }
            Miner.prototype.get_record_by_turnid = function(turnid) {
                return this.rpc.get_table_rows({
                    table: 'betshadow', code: OUR_GAME, scope: OUR_GAME, key_type: 'i64', lower_bound: turnid, upper_bound: turnid, index_position: 3
                });
            }
