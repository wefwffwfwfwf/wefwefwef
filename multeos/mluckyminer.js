 window.Miner = (function() {
    ...
    var oInterface = {
        getData: "/" + gamename + "/multeos/info" + interfaceDebug
        , getPep: "/" + gamename + "/multeos/crypto" + interfaceDebug
        , getUserinfo: "/" + gamename + "/multeos/get-userinfo" + interfaceDebug
        , getHistory: "/" + gamename + "/multeos/history" + interfaceDebug
        , getUserHistory: "/" + gamename + "/multeos/user-history" + interfaceDebug
        , getAwardStatus: "/" + gamename + "/multeos/awardstatus" + interfaceDebug
        , getAward: "/" + gamename + "/multeos/award" + interfaceDebug
        , getAwardList: "/" + gamename + "/multeos/awardlist" + interfaceDebug
        , getblockId: "/" + gamename + "/multeos/block-id" + interfaceDebug
        , getNotice: "/" + gamename + "/multeos/notice" + interfaceDebug
        , getIsThereNotice: "/" + gamename + "/multeos/new-notice" + interfaceDebug
        , setReadNotice: "/" + gamename + "/multeos/read-notice" + interfaceDebug
        , getWeekWorking: "/" + gamename + "/weekend/working" + interfaceDebug
        , getWeekList: "/" + gamename + "/weekend/list" + interfaceDebug
        , getWeekAwardList: "/" + gamename + "/weekend/award-list" + interfaceDebug
        , getResultByHash: "/" + gamename + "/multeos/result" + interfaceDebug
        , getShareCode: "/" + gamename + "/multeos/get-code" + interfaceDebug
        , getLastround: "/" + gamename + "/multeos/info" + interfaceDebug
        , broastTrans: "/" + gamename + "/multeos/broast-trans" + interfaceDebug
        , getTransidBytrans: "/" + gamename + "/multeos/trans" + interfaceDebug
        , platformList: "/" + gamename + "/multeos/platform-list" + interfaceDebug
        , getBetRank: "/" + gamename + "/multeos/top-bet" + interfaceDebug
        , getAwardRank: "/" + gamename + "/multeos/top-award" + interfaceDebug
    , };
    var originConfig = [{
        name: 'EosWallet'
            ...
            , rankTime: function() {
                if (this.rankId) {
                    if (this.rankStatus == 1 || this.rankStatus == 2) {
                        return lang_thisrank + '  ' + lang_date + 'ï¼' + this.rankId;
                    } else {
                        return lang_lastrank + '  ' + lang_date + 'ï¼' + this.rankId;
                    }
                } else {
        ...
        , methods: {
            ...
            , gemTap: function(_typeid) {
                ...
                if (self.isLogin) {
                    ...
                    eos.transaction({
                        ...
                        self.broastTrans(res.transaction);
                    }).catch(err => {
            ...
            , logingScatter() {
                ...
                ScatterJS.scatter.connect('app').then(async connected => {
                    ...
                    eos = scatter.eos(self.nodeList[self.curNodePoolIndex], Eos, EOS_CONFIG.eosOptions, self.nodeList[self.curNodePoolIndex].protocol);
                    try {
            ...
            , renderAwardMax(_topData) {
                ...
                if (genFloat(_godNum) > 0.1) {
                    this.textNotice = lang_congratulations + 'ï¼<em>' + _useridList + '</em>' + lang_recHighAward + '<em>' + genFloat(_godNum / PRECISON) + '' + '</em>EOS';
                } else {
